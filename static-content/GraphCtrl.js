...
//                console.log("monthHeight = "+monthHeight);
    ...
    $scope.renderers["gnuplot"] = {
        create: function() {
            var tsdbRendererLink = function(path, global, graph, metrics) {
            ...
            ret.render = function(global, graph, metrics) {
                ...
                var url = tsdbRendererLink("/q?", global, graph, metrics);
                ...
                if (url != null) {
                    ...
                    ret.tsdb_export_link = tsdbRendererLink("/#", global, graph, metrics);
                }
            }
            return ret;
        }
    ...
    $scope.renderers["horizon"] = {
        create: function() {
            ...
            ret.render = function(global, graph, metrics) {
                ...
                // url construction
                var query_string = $scope.tsdb_queryString(global, graph, metrics, null, function(by) {return downsampleTo+"-"+(by?by:"avg")});
                ...
                $http.get(url, {withCredentials:$rootScope.config.authenticatedReads}).success(function (json) {
                    ...
                    ret.tsdb_export_link = $rootScope.config.tsdbBaseReadUrl + "/#" + query_string;
    ...
    $scope.renderers["heatmap"] = {
        ...
        //                    console.log("Appears we were better off with "+(rows-1)+" rows: "+candidateCellSize);
                ...
                // url construction
                var query_string = $scope.tsdb_queryString(global, graph, metrics, null, downsampleTo ? function(by) {return downsampleTo+"-"+(by?by:"avg")} : null);
                var url = $rootScope.config.tsdbBaseReadUrl+"/api/query";
